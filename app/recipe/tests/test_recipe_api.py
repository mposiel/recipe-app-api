...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_invalid(self):
        """Test creating a recipe with invalid payload."""
        payload = {
            "title": "",
            "time_minutes": 0,
            "price": Decimal("0.00"),
    ...
    def test_full_update_recipe(self):
        ...
        payload = {
            ...
            "time_minutes": 25,
            "price": Decimal("7.25"),
            "link": "http://example.com/recipe-updated.pdf",
    ...
    def test_create_recipe_with_new_tags(self):
        """Tets create a recipe with new tags"""
        payload = {
            "title": "Sample recipe title",
            "time_minutes": 30,
            "price": Decimal("2.80"),
        ...
        self.assertIn(tags[0].name, "Vegan")
        self.assertIn(tags[1].name, "Dessert")

    def test_create_recipe_with_existing_tags(self):
        """Tets create a recipe with existing tags"""
    ...
    def test_create_recipe_with_new_ingredients(self):
        """Test creating a recpie with new ingredients"""
        payload = {
            "title": "Sample recipe title",
            "time_minutes": 30,
            "price": Decimal("2.80"),
    ...
    def test_create_recipe_with_existing_ingredients(self):
        """Test creating a recpie with existing ingredients"""
    ...
    def test_update_recipe_assign_ingredient(self):
        """Test asigning an existing ingredient to a recipe"""
        ingredient_salt = Ingredient.objects.create(
            user=self.user,
            name="Salt"
        )
